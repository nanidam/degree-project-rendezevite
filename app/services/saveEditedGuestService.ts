...
export const saveEditedGuestService = async (
    { guestId, attending, diet, guestEmail, comments, additionalGuestName, guestName, phoneNumber, allergies, additionalGuestAllergies, hasResponded, additionalGuestAttending, additionalGuestDiet }: ISaveEditedGuest
) => {
